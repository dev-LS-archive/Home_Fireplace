...
using UnityEditor;
using UnityEngine;
using TextureToolkit.DataStructures;
using static TextureToolkit.DataStructures.T_DataStructures;
...
namespace TextureToolkit
{
    ...
    {
        [MenuItem("TextureToolkit/Quick Functions/Mass Texture Importer", false, 4)]
